...
#+BEGIN_SRC sh :results raw list
  grep -i "the michael jordan of" mj.txt | sed -e "s/nyt_corpus_//" -e "s/\.har\//\//" -e "s/.xml//" -e "s/[[:space:]]*$//"
#+END_SRC
...
#+BEGIN_SRC sh :results raw list
  grep -i "a michael jordan of" mj.txt | sed -e "s/nyt_corpus_//" -e "s/\.har\//\//" -e "s/.xml//" -e "s/[[:space:]]*$//"
#+END_SRC
...
#+BEGIN_SRC sh :results raw list
  grep -i "of michael jordan of" mj.txt | sed -e "s/nyt_corpus_//" -e "s/\.har\//\//" -e "s/.xml//" -e "s/[[:space:]]*$//"
#+END_SRC
