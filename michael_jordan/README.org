...
#+PLOT: ind:1 deps:(2 3 4 5 6) type:2d with:linespoints set:"yrange [0:]" file:"mj.svg" set:"term svg enhanced size 800,600 lw 2" set:"xlabel 'year" set:"grid on" set:"ylabel 'count" set:"style line 0 pt 7"
