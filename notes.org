...
#+PLOT: ind:1 deps:(2 3) type:2d with:linespoints set:"yrange [0:]" file:"vossantos.png" set:"term png enhanced font 'Arial,16' size 800,600 lw 2" set:"xlabel 'Jahr'" set:"grid on" set:"ylabel 'Vossantos'" set:"ls pt 7"
| year | NYT | Zeit |
|------+-----+------|
| 1987 |   4 |      |
| 1988 |   9 |      |
