...
#+BEGIN_SRC sh
  ./nyt.py --pattern v01_nyt_articles | awk -F'\t' '{print $5}' > v01_nyt_patterns
#+END_SRC
...
| count |         |     |              |              |     |     | example                                                                         |
|-------+---------+-----+--------------+--------------+-----+-----+---------------------------------------------------------------------------------|
|    13 | PERSON, | DT  | ORGANIZATION | IN           | NNS |     |                                                                                 |
|    13 | PERSON, | DT  | ORGANIZATION | IN           | GPE |     |                                                                                 |
|    10 | PERSON, | DT  | ORGANIZATION | IN           | NN  |     |                                                                                 |
|     9 | PERSON, | DT  | ORGANIZATION | IN           | DT  | NN  |                                                                                 |
|     7 | PERSON  | VBZ | DT           | ORGANIZATION | IN  | NN  | (PERSON Mr. Solerwitz) is/VBZ the/DT (ORGANIZATION Babe Ruth) of/IN ripoffs/NNS |
|     7 | PERSON, | DT  | PERSON       | IN           | GPE |     |                                                                                 |
|     7 | PERSON, | DT  | ORGANIZATION | IN           | NN  | NNS |                                                                                 |
|     6 | PERSON, | DT  | ORGANIZATION | IN           | JJ  | NN  |                                                                                 |
|     5 | PERSON, | DT  | ORGANIZATION | IN           | NN  | NN  |                                                                                 |
|     5 | GPE,    | DT  | ORGANIZATION | IN           | NNS |     |                                                                                 |
