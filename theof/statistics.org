...
#+BEGIN_SRC sh
  ...
  for year in $(seq 1987 2007); do
      echo $year \
	   ...
	   $(./org.py -y results.org | grep ${year} | wc -l) \
           $(./org.py -y -c -b results.org | grep ${year} | awk -F'\t' '{if ($2 == "D" || $3 == "True") print;}' | wc -l)
  done
#+END_SRC
...
#+BEGIN_SRC sh
  ./org.py -w -T results.org | sort | uniq -c | sort -nr | head -n40
#+END_SRC
...
#+BEGIN_SRC sh
  for year in $(seq 1987 2007); do
    ...
    for s in "Michael_Jordan" "Rodney_Dangerfield" "Babe_Ruth"; do
      s=$(echo $s| sed "s/_/ /g")
      c=$(./org.py -T -y -l results.org | grep ^$year | awk -F'\t' '{print $2}' | grep "^$s$" | wc -l)
      echo -n "\t$c"
    done
    echo
  done
...
#+BEGIN_SRC sh
  echo "vossantos" $(./org.py -T results.org | wc -l) articles $(wc -l < nyt_categories.tsv)
  ./org.py -T -f results.org | join nyt_categories.tsv - | sed "s/ /\t/" | awk -F'\t' '{print $2}' \
      | sort | uniq -c \
      | sed -e "s/^ *//" -e "s/ /\t/" | awk -F'\t' '{print $2"\t"$1}' \
...
#+BEGIN_SRC sh
  echo "vossantos" $(./org.py -T results.org | wc -l) articles $(wc -l < nyt_desks.tsv)
  ./org.py -T -f results.org | join nyt_desks.tsv - | sed "s/ /\t/" | awk -F'\t' '{print $2}' \
      | sort | uniq -c \
      | sed -e "s/^ *//" -e "s/ /\t/" | awk -F'\t' '{print $2"\t"$1}' \
...
#+BEGIN_SRC sh
  echo "vossantos" $(./org.py -T results.org | wc -l) articles $(wc -l < nyt_authors.tsv)
  ./org.py -T -f results.org | join nyt_authors.tsv - | sed "s/ /\t/" | awk -F'\t' '{print $2}' \
      | sort | uniq -c \
      | sed -e "s/^ *//" -e "s/ /\t/" | awk -F'\t' '{print $2"\t"$1}' \
...
#+BEGIN_SRC sh :results raw
  ...
  for article in $(./org.py -T -f results.org | join nyt_authors.tsv - | grep "Maslin, Janet" | cut -d' ' -f1 ); do
    grep "$article" results.org
  done
#+END_SRC
...
#+BEGIN_SRC sh
./org.py -o -T results.org | sort | uniq -c | sort -nr | head -n30
#+END_SRC
...
#+BEGIN_SRC sh
  ./org.py -w -T -t -c results.org | grep "of\* today" | awk -F'\t' '{print $2}' | sort | uniq -c | sort -nr
#+END_SRC
...
#+BEGIN_SRC sh
  ./org.py -w -T -t -c results.org | grep "of\* his \(day\|time\|generation\)" | awk -F'\t' '{print $2}' | sort | uniq -c  | sort -nr  | head
#+END_SRC
...
#+BEGIN_SRC sh
  ./org.py -w -T -t -c results.org | grep "of\* her day" | awk -F'\t' '{print $2}' | sort | uniq -c | sort -nr
#+END_SRC
...
**** "Japan"
#+BEGIN_SRC sh
  ./org.py -w -T -t -c results.org | grep "of\* Japan" | awk -F'\t' '{print $2}' | sort | uniq -c | sort -nr
#+END_SRC
...
**** "China"
#+BEGIN_SRC sh
  ./org.py -w -T -t -c results.org | grep "of\* China" | awk -F'\t' '{print $2}' | sort | uniq -c | sort -nr
#+END_SRC
...
**** "Brazil"
#+BEGIN_SRC sh
  ./org.py -w -T -t -c results.org | grep "of\* Brazil" | awk -F'\t' '{print $2}' | sort | uniq -c | sort -nr
#+END_SRC
...
**** baseball
#+BEGIN_SRC sh
  ./org.py -w -T -t -c results.org | grep "of\* baseball" | awk -F'\t' '{print $2}' | sort | uniq -c | sort -nr
#+END_SRC
...
**** tennis
#+BEGIN_SRC sh
  ./org.py -w -T -t -c results.org | grep "of\* tennis" | awk -F'\t' '{print $2}' | sort | uniq -c | sort -nr
#+END_SRC
...
**** basketball
#+BEGIN_SRC sh
  ./org.py -w -T -t -c results.org | grep "of\* basketball" | awk -F'\t' '{print $2}' | sort | uniq -c | sort -nr
#+END_SRC
...
**** football
#+BEGIN_SRC sh
  ./org.py -w -T -t -c results.org | grep "of\* football" | awk -F'\t' '{print $2}' | sort | uniq -c | sort -nr
#+END_SRC
...
**** racing
#+BEGIN_SRC sh
  ./org.py -w -T -t -c results.org | grep "of\* racing" | awk -F'\t' '{print $2}' | sort | uniq -c | sort -nr
#+END_SRC
...
**** golf
#+BEGIN_SRC sh
  ./org.py -w -T -t -c results.org | grep "of\* golf" | awk -F'\t' '{print $2}' | sort | uniq -c | sort -nr
#+END_SRC
...
#+BEGIN_SRC sh :results raw
  ./org.py -T -l -t results.org | awk -F'\t' '{if ($1 == "Michael Jordan") print $2}' \
