# This code is an adaption from https://github.com/gao-g/metaphor-in-context
...
def embed_sequence(sequence, word2idx, glove_embeddings, elmo_embeddings):
    ...
    glove_part = glove_embeddings(torch.LongTensor(indexed_sequence))
    ...
    # glove_part are Tensors, so we need to use .data
...
class TextDatasetWithGloveElmo(Dataset):
