...
#+TBLFM: @23$2=vsum(@I..@II)::@23$3=vsum(@I..@II)::@23$4=vsum(@I..@II)::@23$5=vsum(@I..@II)::@23$6=vsum(@I..@II)::@24$2=vmean(@I..@II);%2.1f::@24$3=vmean(@I..@II);%2.1f::@24$4=vmean(@I..@II);%2.1f::@24$5=vmean(@I..@II);%2.1f::@24$6=vmean(@I..@II);%2.1f
...
#+BEGIN_SRC sh 
  grep -i "the michael jordan of\b" mj.txt | sed -r -e "s/.*the michael jordan of *(((the|his|this|her) *)?[^ \.,'\"\)]*).*/\1/i" -e "s/ /_/" | tr 'A-Z' 'a-z' | sort | uniq -c  | sort -nr
#+END_SRC
...
*** "a michael jordan of"
#+BEGIN_SRC sh
  grep -i "a michael jordan of\b" mj.txt | awk -F'\t' '{print $1}' | sed -e "s/.*corpus_//" -e "s/\..*//" | sort | uniq -c
#+END_SRC

#+BEGIN_SRC sh :results raw list
  grep -i "a michael jordan of\b" mj.txt | sed -e "s/nyt_corpus_//" -e "s/\.har\//\//" -e "s/.xml//" -e "s/[[:space:]]*$//" | sed "s/a michael jordan of/*&*/i"
#+END_SRC
...
#+BEGIN_SRC sh
  grep -i "of michael jordan of\b" mj.txt | awk -F'\t' '{print $1}' | sed -e "s/.*corpus_//" -e "s/\..*//" | sort | uniq -c
#+END_SRC

#+BEGIN_SRC sh :results raw list
  grep -i "of michael jordan of\b" mj.txt | sed -e "s/nyt_corpus_//" -e "s/\.har\//\//" -e "s/.xml//" -e "s/[[:space:]]*$//" | sed "s/of michael jordan of/*&*/i"
#+END_SRC
